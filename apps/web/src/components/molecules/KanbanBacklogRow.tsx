...
export interface KanbanBacklogRowProps {
  task: Task;
  taskIndex: number;
...
/** Compact single-line card for the Backlog Kanban column (contract §6). */
export function KanbanBacklogRow({
  task,
  taskIndex,
  isBeingDragged,
  onDragStart,
  ...
  return (
    <motion.div
      ...
      role="button"
      tabIndex={0}
      aria-label={`Edit backlog task: ${task.title}`}
