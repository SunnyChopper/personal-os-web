...
import { summarizeProactiveSuggestionPayload } from '@/lib/proactive/proactive-suggestion-summary';
...
function RejectSuggestionDialogBody({
  ...
  return (
    <>
      ...
      <FormField label="Feedback (optional)" htmlFor="reject-feedback" className="mb-4">
        <Textarea
          id="reject-feedback"
