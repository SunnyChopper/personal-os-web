            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Select
                  value={formData.area}
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, area: e.target.value as Area }))
                  }
      ...
      >
        <div className="p-6 space-y-4">
          <p className="text-gray-600 dark:text-gray-300">
            ...
            <span className="font-medium text-gray-900 dark:text-white">{note?.title}</span>? It
            will be hidden from your vault but can be restored later.
          </p>
