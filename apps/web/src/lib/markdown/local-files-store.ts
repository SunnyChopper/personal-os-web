...
/** True for autogenerated new-file names like `Untitled-1.md` (case-insensitive basename). */
export function isUntitledLocalPath(path: string): boolean {
  const base = path.split('/').pop() || path;
  return /^untitled-\d+\.md$/i.test(base);
}
