...
const STORAGE_KEY = 'vault-note-ai-model-picker';

export function loadVaultNoteAIModelPicker(): BrainstormModelPickerValue | null {
  try {
...
export function saveVaultNoteAIModelPicker(value: BrainstormModelPickerValue): void {
  try {
